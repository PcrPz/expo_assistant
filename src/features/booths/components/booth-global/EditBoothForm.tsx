                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    {(previewUrl || existingImageUrl) ? (
                      <div
                        className="relative w-32 h-32 rounded-2xl overflow-hidden border-4 border-gray-100 shadow-lg cursor-pointer group"
                      ...
                      >
                        ...
                        <div className="absolute inset-0 bg-black/50 flex flex-col items-center justify-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <p className="text-white text-[11px] font-semibold">เปลี่ยนรูป</p>
                        </div>
                      </div>

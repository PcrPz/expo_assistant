...
import { FileText, Eye, Edit2, BarChart3, Trash2, Send, CheckCircle2, Clock, AlertCircle, QrCode } from 'lucide-react';
...
export function FormCard({
  ...
  canManage, onView, onEdit, onViewResults, onDelete, onToggleStatus, onQR,
}: FormCardProps) {

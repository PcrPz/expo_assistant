...
export function CreateFormModal({ expoId, boothId, onClose, onSuccess }: CreateFormModalProps) {
  const [questions, setQuestions] = useState<Question[]>([
    { question_no: 1, question_type: 'text', question_text: '', required: false },
  ]);
          ...
          <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100 flex-shrink-0">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-400">เพิ่มคำถามสำหรับรับ feedback จากผู้เข้าชม</p>
              </div>
            </div>

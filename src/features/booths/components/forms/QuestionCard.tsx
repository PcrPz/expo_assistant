// src/features/booths/components/forms/QuestionCard.tsx
'use client';
    ...
    >
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="flex items-start gap-2 pt-1">
          ...
          <div className="flex-shrink-0 w-7 h-7 rounded-lg bg-[#3674B5] text-white flex items-center justify-center font-bold">
            {index + 1}
          </div>
        </div>
        ...
        <div className="flex-1 space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="w-full flex items-center justify-between gap-3 px-3 py-2.5 bg-white border border-[#E2E8F0] rounded-xl hover:border-[#3674B5] focus:border-[#3674B5] focus:ring-2 focus:ring-[#3674B5]/15 transition group"
              >
                <div className="flex items-center gap-3">
                  {selectedType && (
                    <>
                      <selectedType.icon className="h-4 w-4 text-gray-400 group-hover:text-[#3674B5] transition" />
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2.5 border border-[#E2E8F0] rounded-xl focus:ring-2 focus:ring-[#3674B5]/15 focus:border-[#3674B5] outline-none transition text-sm text-gray-900 placeholder:text-gray-400"
            />
          </div>
